...
<nav class="navbar navbar-expand-lg fixed-top py-3" data-bs-theme="dark"
  ...
  <div class="container">
    <a class="navbar-brand d-flex align-items-center" href="/dashboard/home">
    ...
    <div class="collapse navbar-collapse" id="navMain">
      ...
      <div class="d-flex align-items-center gap-3">
        <form class="d-none d-xl-flex" role="search" method="get" action="/dashboard/home">
        ...
        <div class="d-flex gap-2 align-items-center">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark shadow-lg border-secondary mt-3">
              ...
              <li><a class="dropdown-item py-2" href="/dashboard/home"><i class="fas fa-gauge-high me-2 opacity-50"></i>Dashboard</a></li>
              <li>
                <form action="/scripts/logout_process.php" method="post" class="m-0">
