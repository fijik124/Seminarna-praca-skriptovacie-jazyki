...
try {
    ...
    $stmt = \Core\Database::getInstance()->prepare('SELECT id, name, created_at, updated_at FROM `tracks` ORDER BY created_at DESC');
    $stmt->execute();
...
$registredThisMonth = array_map(static function (array $track) {
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="d-flex justify-content-lg-end gap-2">
                        <a href="<?= url('dashboard/tracks-create') ?>" class="btn btn-outline-light">Create Track</a>
                        <a href="<?= url('dashboard/tracks') ?>" class="btn btn-primary">View Tracks</a>
                    </div>
                </div>
            </div>
        </div>
