                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-3">
                                            <div class="d-inline-flex gap-2">
                                                ...
                                                <?php if ($authRepo->hasPermission('track_delete')): ?>
                                                    <form action="" method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this track?');" class="m-0">
